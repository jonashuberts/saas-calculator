...
import { CostInput, SubscriptionInput, calculateAggregatedProjections, calculateActualCostProjections, calculateTotalPastSavings, calculateHistoricalSpend, calculateTotalHistoricalSpend } from "@/lib/calculator";
...
import { PiggyBank, RefreshCw, Plus, Edit2, X, AppWindow, Globe } from "lucide-react";
  ...
  return (
    <div className="min-h-screen relative text-foreground selection:bg-emerald-500/30 font-sans">
      ...
      <main className="container mx-auto px-4 py-6 max-w-7xl space-y-8">
        ...
        {/* Global Projections */}
        <div className="pt-4">
          <SavingsVisualizations projections={projections} actualProjections={actualProjections} subscriptions={subscriptions} currency={currency} hideCommandCenter />
        </div>
